package com.example.covid_19statistics.ui.adapter;
...
import com.example.covid_19statistics.ui.activity.DetailActivity;
...
public class CountryAdapter extends RecyclerView.Adapter<com.example.covid_19statistics.ui.adapter.CountryAdapter.CountryHolder> implements Filterable {
        ...
        if (this.countriesList == null) {
            ...
            final DiffUtil.DiffResult result = DiffUtil.calculateDiff(new DiffUtil.Callback() {
                ...
                public int getOldListSize() {
                    return com.example.covid_19statistics.ui.adapter.CountryAdapter.this.countriesList.size();
                }
                ...
                public boolean areItemsTheSame(int oldItemPosition, int newItemPosition) {
                    return com.example.covid_19statistics.ui.adapter.CountryAdapter.this.countriesList.get(oldItemPosition).getCountry() == countriesList.get(newItemPosition).getCountry();
                }

                @Override
                public boolean areContentsTheSame(int oldItemPosition, int newItemPosition) {

                    CountriesResponse newMovie = com.example.covid_19statistics.ui.adapter.CountryAdapter.this.countriesList.get(oldItemPosition);
