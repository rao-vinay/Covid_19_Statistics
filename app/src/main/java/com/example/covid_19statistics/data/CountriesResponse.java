...
public class CountriesResponse {
    ...
    private com.example.covid_19statistics.data.CountryInfo countryInfo;
    ...
    public com.example.covid_19statistics.data.CountryInfo getCountryInfo() {
        return countryInfo;
    }

    public void setCountryInfo(com.example.covid_19statistics.data.CountryInfo countryInfo) {
